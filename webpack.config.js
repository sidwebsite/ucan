...
module.exports = {
    ...
    plugins:[
        ...
        new HtmlWebpackPlugin({
            ...
            minify: false,
            chunks: ['main', 'menu', 'footer', 'shareFeedback']
        }),
        // 檔案下載
        new HtmlWebpackPlugin({
        ...
        new HtmlWebpackPlugin({
            ...
            minify: false,
            chunks: ['main', 'menu','search_1_4', 'footer']
        }),
        new HtmlWebpackPlugin({
        ...
        new HtmlWebpackPlugin({
            ...
            minify: false,
            chunks: ['main', 'menu', 'sticky', 'footer']
        }),
        new HtmlWebpackPlugin({
        ...
        new HtmlWebpackPlugin({
            ...
            minify: false,
            chunks: ['main', 'menu', 'diagnose_3_1_3', 'footer']
        }),
        // 職能診斷-共通職能診斷
        new HtmlWebpackPlugin({
        ...
        new HtmlWebpackPlugin({
            ...
            minify: false,
            chunks: ['main', 'menu','diagnose_3_2_3', 'footer']
        }),
        // 職能診斷-專業職能診斷
        new HtmlWebpackPlugin({
        ...
        new HtmlWebpackPlugin({
            ...
            minify: false,
            chunks: ['main', 'menu', 'recode_4_3_2', 'footer']
        }),
        new HtmlWebpackPlugin({
        ...
        new HtmlWebpackPlugin({
            ...
            minify: false,
            chunks: ['main', 'menu','recode_4_4', 'footer']
        }),
        new HtmlWebpackPlugin({
        ...
        new HtmlWebpackPlugin({
            ...
            minify: false,
            chunks: ['main', 'menu','contactUs_login', 'footer']
        }),
        // 修改密碼 
        new HtmlWebpackPlugin({
